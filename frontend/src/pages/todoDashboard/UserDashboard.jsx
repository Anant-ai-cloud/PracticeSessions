            ...
            <div className={`card ${todo.completed ? "bg-green-300 text-black" : "bg-primary  text-primary-content"}   w-96 m-4`} key={todo._id}>
              <div className="card-body">
                ...
                <dialog id='updatemodal' className='modal'>
                  ...
                  <form className='border border-white bg-gray-500 p-5'>
                    <button type='button' className='relative left-[290px] text-white' onClick={()=> document.getElementById("updatemodal").close()}>X</button>
                    <div>
                      <label htmlFor="title" className='text-white'>Updated Title</label> <br />
                      <input id='title' type="text" className='input w-[290px] mt-2 text-white' />
                    </div>
                    <div>
                      <label htmlFor="description" className='text-white'>Updated Description</label> <br />
                      <textarea  id="description" className='w-[290px] h-[100px] text-white mt-2'/>
                    </div>
                  </form>
