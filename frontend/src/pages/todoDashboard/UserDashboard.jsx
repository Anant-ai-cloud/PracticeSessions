            ...
            <div className={`card ${todo.completed ? "bg-green-300 text-black" : "bg-primary  text-primary-content"}   w-96 m-4`} key={todo._id}>
              <div className="card-body">
                ...
                <dialog id='updatemodal' className='modal'>
                  ...
                  <form key={todo._id} onSubmit={(e)=> {handleSubmit(e,{title: title, description: description}, todo._id)}}>
                  ...
                  <button type='button' className='relative left-[290px] text-white p-2 rounded-md' onClick={()=> {document.getElementById("updatemodal").close()} }>X</button>
                    <div>
                      ...
                      {console.log(todo.title)}
                      <input id="title"  type="text" className='input w-[290px] mt-2 mb-2 text-white focus: outline-none border border-white bg-[#1E293B]'
                      {...register("title",{
                        required: true
                      })}
                      />
                    ...
                    <div>
                      ...
                      <textarea  id="description" className='w-[290px] h-[100px] text-white mt-2 focus: outline-none border border-white bg-[#1E293B]' {...register("description")}/>
